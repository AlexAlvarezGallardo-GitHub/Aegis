...
/**
 * Binds the {@code aegis.kafka.topics} configuration map (event type to Kafka topic).
 * <p>
...
public class KafkaTopicsProperties {
     ...
     *
     * @param eventType the domain event type (e.g. {@code FRAUD_ASSESSMENT_COMPLETED})
