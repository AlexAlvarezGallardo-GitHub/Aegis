...
/**
 * Enforces hexagonal architecture boundaries for the Fraud service.
 */
class ArchitectureTest {
    ...
    private static final JavaClasses IMPORTED = new ClassFileImporter()
            ...
            .importPackages("com.aegis.fraud");

    @Test
    void domainLayerIsFrameworkFree() {
        ArchRule rule = noClasses()
                .that().resideInAPackage("com.aegis.fraud.domain..")
                .should().dependOnClassesThat()
                .resideInAnyPackage("org.springframework..", "jakarta.persistence..", "org.hibernate..",
                        "io.swagger..", "org.springdoc..", "com.aegis.fraud.infrastructure..", "com.aegis.fraud.web..")
    ...
    void applicationDependsOnlyOnDomainAndApplication() {
        ArchRule rule = noClasses()
                .that().resideInAPackage("com.aegis.fraud.application..")
                .should().dependOnClassesThat()
                .resideInAnyPackage("com.aegis.fraud.infrastructure..", "com.aegis.fraud.web..")
    ...
    void webDependsOnlyOnApplicationAndDomain() {
        ArchRule rule = noClasses()
                .that().resideInAPackage("com.aegis.fraud.web..")
                .should().dependOnClassesThat()
                .resideInAPackage("com.aegis.fraud.infrastructure..")
    ...
    void controllersCarryNoSwaggerAnnotations() {
        ArchRule rule = classes()
                .that().resideInAPackage("com.aegis.fraud.web.controller..")
