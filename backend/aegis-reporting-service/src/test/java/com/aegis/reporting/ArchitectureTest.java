...
/**
 * Enforces hexagonal architecture boundaries for the Reporting service.
 */
class ArchitectureTest {
    ...
    private static final JavaClasses IMPORTED = new ClassFileImporter()
            ...
            .importPackages("com.aegis.reporting");

    @Test
    void domainLayerIsFrameworkFree() {
        ArchRule rule = noClasses()
                .that().resideInAPackage("com.aegis.reporting.domain..")
                .should().dependOnClassesThat()
                .resideInAnyPackage("org.springframework..", "jakarta.persistence..", "org.hibernate..",
                        "io.swagger..", "org.springdoc..", "com.aegis.reporting.infrastructure..")
    ...
    void applicationDependsOnlyOnDomainAndApplication() {
        ArchRule rule = noClasses()
                .that().resideInAPackage("com.aegis.reporting.application..")
                .should().dependOnClassesThat()
                .resideInAPackage("com.aegis.reporting.infrastructure..")
