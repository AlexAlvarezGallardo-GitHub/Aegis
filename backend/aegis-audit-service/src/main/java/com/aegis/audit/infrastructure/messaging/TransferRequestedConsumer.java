...
/**
 * Kafka consumer that listens for {@code payment.transfer.requested} events.
 * <p>
...
public class TransferRequestedConsumer {
    ...
    public TransferRequestedConsumer(TransferAuditRecordService transferAuditRecordService,
    ...
    /**
     * Consumes a {@link TransferRequestedEvent} from Kafka, maps it to a
     * {@link TransferAuditRecord}, and persists it to the database.
     *
     * @param event     the deserialized transfer requested event
     * @param topic     the source topic
     * @param partition the source partition
     * @param offset    the source offset
     */
    @KafkaListener(
            topics = "${aegis.kafka.topics.transfer-requested}",
            groupId = "${spring.kafka.consumer.group-id}",
            containerFactory = "transferRequestedListenerContainerFactory"
    )
    @Transactional
    public void consume(TransferRequestedEvent event,
        ...
        log.info("Received TransferRequestedEvent: eventId={}, transferId={}, amount={} {}",
