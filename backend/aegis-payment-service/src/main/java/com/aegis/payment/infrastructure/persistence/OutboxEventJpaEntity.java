...
/**
 * JPA entity representing a domain event persisted in the transactional outbox.
 */
@Entity
...
public class OutboxEventJpaEntity {
    ...
    /**
     * Creates a new outbox event in {@code PENDING} status.
     *
    ...
    /**
     * Marks this outbox event as published to Kafka.
     */
