...
/**
 * Domain event published when a new transfer is requested.
 */
public record TransferRequested(
    ...
    private static final String EVENT_TYPE = "TRANSFER_REQUESTED";
     ...
     *
     * @param transfer the newly requested transfer
     */
