...
/**
 * Enforces hexagonal architecture boundaries for the Wallet service.
 */
class ArchitectureTest {
    ...
    private static final JavaClasses IMPORTED = new ClassFileImporter()
            ...
            .importPackages("com.aegis.wallet");

    @Test
    void domainLayerIsFrameworkFree() {
        ArchRule rule = noClasses()
                .that().resideInAPackage("com.aegis.wallet.domain..")
                .should().dependOnClassesThat()
                .resideInAnyPackage("org.springframework..", "jakarta.persistence..", "org.hibernate..",
                        "io.swagger..", "org.springdoc..", "com.aegis.wallet.infrastructure..", "com.aegis.wallet.web..")
    ...
    void applicationDependsOnlyOnDomainAndApplication() {
        ArchRule rule = noClasses()
                .that().resideInAPackage("com.aegis.wallet.application..")
                .should().dependOnClassesThat()
                .resideInAnyPackage("com.aegis.wallet.infrastructure..", "com.aegis.wallet.web..")
    ...
    void webDependsOnlyOnApplicationAndDomain() {
        ArchRule rule = noClasses()
                .that().resideInAPackage("com.aegis.wallet.web..")
                .should().dependOnClassesThat()
                .resideInAPackage("com.aegis.wallet.infrastructure..")
    ...
    void controllersCarryNoSwaggerAnnotations() {
        ArchRule rule = classes()
                .that().resideInAPackage("com.aegis.wallet.web.controller..")
